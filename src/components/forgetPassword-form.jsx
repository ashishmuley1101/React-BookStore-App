                            ...
                            <div class="form-constrains">
                                ...
                                <div class="row-content">
                                    <TextField type="text" name="email" fullWidth className="input" variant='outlined'
                                        placeholder="Enter Your Confirm Email." id="email" label="Email" required
                                ...
                                <div class="row-content">
                                    <TextField name="verificationCode" fullWidth variant='outlined'
                                        placeholder="Enter Your Verification Code." id="verificationCode" label="Verification Code" required
